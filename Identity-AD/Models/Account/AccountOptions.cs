...
namespace CustomIdentityServer4.Models
{
    public class AccountOptions
    {
        ...
        public static string InvalidOtpErrorMessage = "Invalid input paramaters";
        public static string ExpiredOtpErrorMessage = "The otp is expired";
        public static string NotMatchOtoErrorMessage = "The otp is not match with what sent to your mobile";
    }
}
